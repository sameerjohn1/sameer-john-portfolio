        ...
        >
          ...
          >
            ...
            <div className="block dark:hidden">
              <span className="bg-gradient-to-r from-purple-600 via-primary to-sky-500 bg-clip-text text-transparent">
                Sameer John
              </span>
            </div>
          ...
          >
            ...
            architecture, intuitive user experiences, and modern development
            practices. Specialized in React.js, Next.js, and MERN stack
            development.
          </motion.p>
          ...
          >
            {[
              {
                icon: Github,
                href: "https://github.com/sameerjohn1",
                label: "GitHub",
              },
              {
                icon: Linkedin,
                href: "https://www.linkedin.com/in/sameer-john-dev/",
                label: "LinkedIn",
              },
              {
                icon: Mail,
                ...
                <div className="grid grid-cols-2 gap-2.5 w-full text-left bg-muted/40 p-3 rounded-xl border border-border/50">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-emerald-500 text-xs flex items-center gap-1">
                      <span className="text-[8px]">●</span> Open to Work
                    </span>
                  </div>
                </div>

                {/* Barcode & Professional ID */}
