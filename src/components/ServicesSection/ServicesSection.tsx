...
const services = [
  {
    ...
    description:
      "Building scalable web applications with React, Next.js, Node.js, Express, and MongoDB.",
  },
  {
    icon: Palette,
    title: "Modern UI Development",
    description:
      "Creating responsive, accessible interfaces with clean design systems and intuitive user experiences.",
  },
  {
    icon: Cpu,
    title: "Performance Optimization",
    description:
      "Improving application speed, rendering performance, and overall user experience through optimized code.",
  },
  {
    icon: Layers,
    title: "API & Backend Integration",
    description:
      "Developing reliable APIs and integrating databases, authentication, third-party services, and modern web tools.",
  },
];
    ...
    <section id="services" className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          Crafting scalable web applications with clean architecture and modern
          technologies.
        </p>
      </motion.div>
